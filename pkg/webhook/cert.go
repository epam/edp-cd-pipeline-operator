...
const (
	...
	secretCertsName = "edp-cd-pipeline-operator-webhook-certs"
	...
	serviceName = "edp-cd-pipeline-operator-webhook-service"
	// validatingWebHookName is the name of the ValidatingWebhookConfiguration resource used for webhook configuration.
	validatingWebHookName = "edp-cd-pipeline-operator-validating-webhook-configuration"
)
