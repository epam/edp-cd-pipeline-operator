...
func schema_pkg_apis_edp_v1alpha1_CDPipeline(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("cd-pipeline-handler-controller/pkg/apis/edp/v1alpha1.CDPipelineSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("cd-pipeline-handler-controller/pkg/apis/edp/v1alpha1.CDPipelineStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"cd-pipeline-handler-controller/pkg/apis/edp/v1alpha1.CDPipelineSpec", "cd-pipeline-handler-controller/pkg/apis/edp/v1alpha1.CDPipelineStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
