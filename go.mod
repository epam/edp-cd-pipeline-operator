...
require (
	...
	github.com/epam/edp-codebase-operator/v2 v2.3.0-95.0.20260409074152-c90432564f34
...
// Argo CD packages requires these dependencies to be replaced
// More info: https://argo-cd.readthedocs.io/en/stable/user-guide/import/
replace (
