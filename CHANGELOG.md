...
- bump codebase-operator to preserve image digest in CBIS
...
- update commit message patterns and CHANGELOG
...
[Unreleased]: https://github.com/epam/edp-cd-pipeline-operator/compare/v2.29.0...HEAD
